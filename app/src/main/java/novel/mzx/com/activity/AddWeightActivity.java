    ...
    protected void initView() {
        ...
        SwipeRefreshLayout.OnRefreshListener listener = new SwipeRefreshLayout.OnRefreshListener() {
            public void onRefresh() {
                Random random = new Random();
                String url = "http://106.14.135.179/ImmersionBar/" + random.nextInt(40) + ".jpg";
                Glide.with(AddWeightActivity.this).asBitmap().load(url)
                        .apply(new RequestOptions().placeholder(R.mipmap.icon_defoat))
                        .into(mIv);
        ...
        databaseHelper = new MyDatabaseHelper(this,"weightInfo.db",null,1);
        ...
        button_add.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(height.equals("") || weight.equals("") ||age.equals("") ||mubiao.equals("")){
                    ToastUtils.showToast(AddWeightActivity.this,"Please enter complete information!");
                    return;
                }
                ...
                values.put("sex",sex);
                values.put("userId", (String)SPUtils.get(AddWeightActivity.this,"userId",""));
